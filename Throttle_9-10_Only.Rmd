...
Tp <- rep(0,24)
throttle_hours <- c(10) #hours that throttling occurs
...
Demand_Graph <- ggplot(data = graph_table, aes(x = Hr)) +
 ...
 theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
  ...
  labs(title="Hourly Demand Forecast", 
       subtitle="50% Throttling 9 AM - 10 AM",
  ...
  geom_rect(aes(xmin=9,xmax=10,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
