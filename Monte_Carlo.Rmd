...
write_csv(PW1S$sim_result_summary, "Results/Workplaces_PW1S_Demand_Summary.csv")

#run emissions and write to csv
PW1S_output_table <- emissions_fcn(PW1S) 
#View(PM1_output_table$Emissions_Table)
#View(PM1_output_table$Emissions)
write_csv(PW1S_output_table$Emissions_Table, "Results/Workplaces_PW1S_Output_Summary.csv") #write emissions to csv
write_csv(PW1S_output_table$Emissions, "Results/Workplaces_PW1S_Output_All_Hours.csv")
...
PW1S_demand_summary <- read_csv("Results/Workplaces_PW1S_Demand_Summary.csv") 
...
>>>>>>> 9f48ffc7055dd3e2f89831e5d9c0a99bff3c60da
                       sim_air_pollution_comm = a_p_co,
                       sim_price_comm = TRUE,
                       sim_curt_year=c_yr)
