...
PW1S <- simulation( sim_seg = "Workplace",
                       ...
                       sim_curt_year=2018)
#View(PW1S$sim_result_summary)
#PW1S_output_table <- emissions_fcn(PW1S) 


graph_tablePW1S <- PW1S$sim_result_summary[c("Hr","X0_mean","Xf_mean")] %>%
  gather(condition,value,c("X0_mean","Xf_mean")) 
#%>% mutate(Theoretical_Max=PW1S$sim_result_EV_Demand$MT[1])
...
#View(PDC2S$sim_result_summary)
#PDC2S_output_table <- emissions_fcn(PDC2S) 

#PDC3S: discount -0.05 (default) 12-15+ air poll comms + morning throttling
PDC3S <- simulation(sim_seg = "Destination Center",sim_throttle_amount = -0.5,sim_air_pollution_comm = TRUE, sim_price_comm = FALSE,sim_month = 7)
#View(PDC3S$sim_result_summary)
#PDC3S_output_table <- emissions_fcn(PDC3S) 

#PDC4S: discount -0.05 (default) 12-15+ no comms + morning throttling
PDC4S <- simulation(sim_seg = "Destination Center",sim_throttle_amount =-0.5, sim_month = 7,sim_air_pollution_comm = FALSE,sim_price_comm = FALSE)
#View(PDC4S$sim_result_summary)
...
PF1 <- simulation(simulations = 100, 
                       ...
                       sim_air_pollution_comm = a_p_co,
                       sim_price_comm = TRUE)
#View(PF1S$sim_result_summary)
#PF1S_output_table <- emissions_fcn(PF1S) 
...
PF3S <- simulation(simulations = 100, 
                       sim_method = mthd,
                       sim_avg_elasticity = avg_elst,
                       sim_seg = "Fleet",
                       sim_month = 7, 
...
PF4S <- simulation(simulations = 100, 
                       ...
                       sim_int_equals_baseline = int_e_b, 
                       sim_throttle_amount = -0.5, 
                       sim_throttle_hours = c(6:11, 17:21),  ????
                       sim_air_pollution_comm = a_p_co,
                       sim_price_comm = TRUE,
                       sim_curt_year=c_yr)
...
FF1 <- simulation(simulations = 100, 
                       sim_method = mthd,
                       sim_avg_elasticity = avg_elst,
                       sim_seg = "Fleet",
                       sim_month = mth, 
...
write_csv(PM1$sim_result_summary, "Results/PM1_Demand_Summary.csv")
#run emissions and write to csv
PM1_output_table <- emissions_fcn(PM1) 
write_csv(PM1_output_table$Emissions_Table, "Results/PM1_Output_Summary.csv") #write emissions to csv
write_csv(PM1_output_table$Emissions, "Results/PM1_Output_All_Hours.csv")
...
PM2 <- simulation(sim_seg = "Multi Unit Dwelling",
                       sim_month = 11,
                       sim_year = 2018,
                       sim_include_wknds = FALSE,
                       sim_price_change = 0,
...
PM3 <- simulation (sim_seg = "Multi Unit Dwelling",
                       sim_month = 11,
                       sim_year = 2018,
                       sim_include_wknds = FALSE,
                       sim_price_change = 0.1, 
...
PM4 <- simulation (sim_seg = "Multi Unit Dwelling",
                       sim_month = 11,
                       sim_year = 2018,
                       sim_include_wknds = FALSE,
                       sim_price_change = 0,
...
PM5 <- simulation (sim_seg = "Multi Unit Dwelling",
                       sim_month = 11,
                       sim_year = 2018,
                       sim_include_wknds = FALSE,
                       sim_price_change = 0,
...
FM1 <- simulation (sim_seg = "Multi Unit Dwelling",
                       sim_month = 11,
                       sim_year = 2018,
                       sim_include_wknds = FALSE,
                       sim_price_change = 0.1, 
...
#FM1_output_table <- emissions_fcn(EVDemand = FM1, peak_hours = c(17:21), emissions_year = 2030)
