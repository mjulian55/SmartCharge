...
emissions_fcn_event <- function(EVDemand, peak_hours = pk, emissions_year = yr) {
...
Emissions <- data.frame(Hr = c(1:24)) %>% 
  ...
  mutate(curt = EVDemand$EV_Demand$Curt) %>% 
  mutate(Xdelta = EVDemand$EV_Demand$Xint_effect) %>% 
     # column for new demand at each hour. we'll need to update "Xt" to reflect the new column post comms/all interventions
  mutate(Pbase = EVDemand$EV_Demand$P0*EVDemand$EV_Demand$X0) %>% #total price paid in that hour ($/kwh * kwh)
  mutate(Pnew = EVDemand$EV_Demand$P1*EVDemand$EV_Demand$Xf) #total price paid in that hour ($/kwh * kwh)
...
#PW2S = discount + price comm + morning throttling
...
Demand_GraphPW1S <- ggplot(data = graph_tablePW1S, aes(x = Hr)) +
  ...
  labs(title="Workplaces (PW1S) Hourly Demand Forecast\n (discount, price comm, throttling)",
  subtitle="Baseline July 2018 (596 Chargers) \n Model Simulation",
...
Demand_GraphPW2S <- ggplot(data = graph_tablePW2S, aes(x = Hr)) +
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="Workplaces (PW2S) Hourly Demand Forecast\n (discount, price comm, throttling, TOU 2019)",
  subtitle="Baseline July 2018 (596 Chargers) \n Model Simulation",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
...
Demand_GraphPW3S <- ggplot(data = graph_tablePW3S, aes(x = Hr)) +
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="Workplaces (PW3S) Hourly Demand Forecast\n(discount, all comm, throttling)",
  subtitle="Baseline July 2018 (596 Chargers) \n Model Simulation",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
...
Demand_GraphPW4S <- ggplot(data = graph_tablePW4S, aes(x = Hr)) +
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="Workplaces (PW4S) Hourly Demand Forecast\n(discount, price comm)",
  subtitle="Baseline July 2018 (596 Chargers) \n Model Simulation",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
...
#FW1 Graph (discount + throttling + air poll & price comm, TOU19 intervention, 2030 chargers)
...
Demand_GraphFW1 <- ggplot(data = graph_tableFW1, aes(x = Hr)) +
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="Workplaces (FW1) Hourly Demand Forecast\n(discount, throttling, air & price comm, TOU 19, 2030 chargers)",
  subtitle="Baseline July 2018 (31435 Chargers) \n Model Simulation",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=6,xmax=11,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
PDC1S <- simulation(simulation = 1000,
...
View(PDC2S_output_table$Emissions_Table)
View(PDC2S_output_table$Emissions)
...
PDC4S <- simulation(simulations = 1000,
                    sim_seg = "Destination Center",
                    sim_throttle_amount = -0.5,
                    sim_month = 7,
                    sim_year = 2018,
...
View(PDC4S_output_table$Emissions_Table)
View(PDC4S_output_table$Emissions)
...
Demand_GraphPDC1S <- ggplot(data = graph_tablePDC1S, aes(x = Hr)) +
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="Destination Centers SC.1 (discount+price com+throttling 6-11) Hourly Demand Forecast",
...
Demand_GraphPDC2S <- ggplot(data = graph_tablePDC2S, aes(x = Hr)) +
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="Destination Centers SC.2 (discount+all comms+morning+throttling 6-11) Hourly Demand Forecast",
  subtitle="Baseline July 2018 (234 Chargers) Model Simulation",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=6,xmax=11,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
Demand_GraphFDC1 <- ggplot(data = graph_tableFDC1, aes(x = Hr)) +
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="Destination Centers SC.6 Hourly Demand Forecast n\(Discount+all comms+throttling 12-15) ",
  subtitle="Summer 2030 2018 (4378 Chargers) Model Simulation",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=7,xmax=11,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
  geom_rect(aes(xmin=12,xmax=15,ymin=-Inf,ymax=Inf, fill = "Discount"),alpha=0.0075) +
  scale_x_continuous(breaks = 1:24, limits = c(1,24), expand = c(0, 0)) +
  scale_color_manual(labels=c("Baseline Demand","Intervention Demand"), values = c("purple", "blue")) +
  theme(plot.title = element_text(hjust = 0.5)) +
  theme(plot.subtitle = element_text(hjust = 0.5))+
...
#Demand_GraphFDC1
ggsave("Results Graphs/Destination_Centers_FDC1_Demand_Summary.png", Demand_GraphPDC5S, device = "png", width = 8, height = 4.5)

#PDC1S:  discount -0.05 (default) 12-15+ price comms only + morning throttling
write_csv(PDC1S$sim_result_summary, "Results/Destination_Centers_PDC2S_Demand_Summary.csv")
#run emissions and write to csv
...
# PF2: Present, Fleet, 2 (rebate, price comm, new 2019 TOU rate, 83 chargers)
...
Demand_GraphPF2 <- ggplot(data = graph_tablePF2, aes(x = Hr)) +
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="Fleets (PF2) (rebate, price comm, new 2019 TOU rate) Hourly Demand Forecast",
  subtitle="Baseline November 2018 (83 Chargers) \n Model Simulation",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
...
# PF3S: Present, Fleet, 3(discount, 100% price comm)
...
# PF4S: Present, Fleet, 4, Summer
# $0.05 Discount (12:00 – 15:00); 100% Price Communication; 50% Throttling (07:00-11:00 and 17:00-21:00)
...
# PF5S: Present, Fleet, 5, Summer
# $0.05 Discount (12:00 – 15:00); $0.10 Rebate (17:00 – 21:00); 2019 New Summer TOU rate; 100% Price Communication
...
Demand_GraphFF1 <- ggplot(data = graph_tableFF1, aes(x = Hr)) +
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="Fleets (FF1) (2019 tou, price comm, 4378 chargers, rebate) Hourly Demand Forecast",
...
Demand_Graph13 <- ggplot(data = graph_table13, aes(x = Hr)) +
  ...
  subtitle="November 2018 Baseline Scaled for November 14th, 2018 Event (546 Chargers) \n Event Usage November 14th, 2018 Event",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=6,xmax=11,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
Nov_14_18_WP_output_table <- emissions_fcn_event(Nov_14_18_WP_scaled_baseline) 
...
Demand_Graph14 <- ggplot(data = graph_table14, aes(x = Hr)) +
  ...
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="Workplace Hourly Demand Forecast",
  subtitle="November 2018 Baseline Scaled for November 28th, 2018 Event (434 Chargers) \n Event Usage November 28th, 2018 Event",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=6,xmax=11,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
Nov_28_18_WP_output_table <- emissions_fcn_event(Nov_28_18_WP_scaled_baseline) 
...
Demand_Graph15 <- ggplot(data = graph_table15, aes(x = Hr)) +
  ...
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="Workplace Hourly Demand Forecast",
  subtitle="October 2018 Baseline Scaled for October 30th, 2018 Event (377 Chargers) \n Event Usage October 30th, 2018 Event",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=6,xmax=11,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
Oct_30_18_WP_output_table <- emissions_fcn_event(Oct_30_18_WP_scaled_baseline) 
...
Demand_Graph16 <- ggplot(data = graph_table16, aes(x = Hr)) +
  ...
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="Workplace Hourly Demand Forecast",
  subtitle="October 2018 Baseline Scaled for October 16th, 2018 Event (494 Chargers) \n Event Usage October 16th, 2018 Event",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=6,xmax=11,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
Oct_16_18_WP_output_table <- emissions_fcn_event(Oct_16_18_WP_scaled_baseline) 
...
Sep_27_18_WP_output_table <- emissions_fcn_event(Sep_27_18_WP_scaled_baseline) 
...
Demand_Graph18 <- ggplot(data = graph_table18, aes(x = Hr)) +
  ...
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="Workplace Hourly Demand Forecast",
  subtitle="August 2018 Baseline Scaled for August 30, 2018 Event (442 Chargers) \n Event Usage August 30, 2018 Event (Load Reduction)",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=16,xmax=21,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
Aug_30_18_WP_output_table <- emissions_fcn_event(Aug_30_18_WP_scaled_baseline) 
...
Demand_Graph19 <- ggplot(data = graph_table19, aes(x = Hr)) +
  ...
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="Workplace Hourly Demand Forecast",
  subtitle="July 2018 Baseline Scaled for July 31, 2018 LR Event (396 Chargers) \n Event Usage July 31, 2018 Event (Load Reduction)",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=16,xmax=21,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
Jul_31_18_WP_output_table <- emissions_fcn_event(Jul_31_18_WP_scaled_baseline) 
...
Demand_Graph43 <- ggplot(data = graph_table43, aes(x = Hr)) +
  ...
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="Workplace Hourly Demand Forecast",
  subtitle="July 2018 Baseline Scaled for July 11, 2018 Event (464 Chargers) \n Event Usage July 11, 2018 Event (Load Reduction)",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=16,xmax=21,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
#Emissions Results
#View(Sep_27_18_WP_scaled_baseline$EV_Demand)
write_csv(Jul_11_18_scaled_model_run$EV_Demand, "Event Results/Workplace_Jul_11_18_Demand_Summary.csv")
Jul_11_18_WP_output_table <- emissions_fcn_event(Jul_11_18_WP_scaled_baseline) 
...
Demand_Graph20 <- ggplot(data = graph_table18, aes(x = Hr)) +
  ...
  subtitle="November 2018 Baseline Scaled for November 28th, 2018 Event (146 Chargers) \n Event Usage November 28th, 2018 Event",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=6,xmax=11,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
Nov_28_18_DC_output_table <- emissions_fcn_event(Nov_28_18_DC_scaled_baseline) 
...
Nov_14_18_DC_output_table <- emissions_fcn_event(Nov_14_18_DC_scaled_baseline) 
...
Demand_Graph22 <- ggplot(data = graph_table22, aes(x = Hr)) +
  ...
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="Destination Center Hourly Demand Forecast",
  subtitle="October 2018 Baseline Scaled for October 30, 2018 Event (150 Chargers) \n November 14th, 2018 Event Usage",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=6,xmax=11,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
Oct_30_18_DC_output_table <- emissions_fcn_event(Oct_30_18_DC_scaled_baseline) 
...
Oct_16_18_DC_output_table <- emissions_fcn_event(Oct_16_18_DC_scaled_baseline) 
...
Sep_27_18_DC_output_table <- emissions_fcn_event(Sep_27_18_DC_scaled_baseline) 
...
Aug_30_18_DC_output_table <- emissions_fcn_event(Aug_30_18_DC_scaled_baseline) 
...
Demand_Graph26 <- ggplot(data = graph_table26, aes(x = Hr)) +
  ...
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="Destination Center Hourly Demand Forecast",
  subtitle="July 2018 Baseline Scaled for July 31, 2018 Event (172 Chargers) \n July 31, 2018 Event Usage (Load Reduction)",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=16,xmax=21,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
Jul_31_18_DC_output_table <- emissions_fcn_event(Jul_31_18_DC_scaled_baseline) 
...
Demand_Graph27 <- ggplot(data = graph_table27, aes(x = Hr)) +
  ...
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="Destination Center Hourly Demand Forecast",
  subtitle="July 2018 Baseline Scaled for July 11, 2018 Event (176 Chargers) \n July 11, 2018 Event Usage (Load Reduction)",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=16,xmax=21,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
Jul_11_18_DC_output_table <- emissions_fcn_event(Jul_11_18_DC_scaled_baseline) 
write_csv(Jul_11_18_DC_output_table$Emissions_Table, "Event Results/DC_Jul_3=11_18_Output_Summary.csv") #write emissions to csv
...
Nov_28_18_Fleet_output_table <- emissions_fcn_event(Nov_28_18_Fleet_scaled_baseline) 
...
Nov_14_18_Fleet_output_table <- emissions_fcn_event(Nov_14_18_Fleet_scaled_baseline) 
...
Oct_30_18_Fleet_output_table <- emissions_fcn_event(Oct_30_18_Fleet_scaled_baseline) 
...
Oct_16_18_Fleet_output_table <- emissions_fcn_event(Oct_16_18_Fleet_scaled_baseline) 
...
Sep_27_18_Fleet_output_table <- emissions_fcn_event(Sep_27_18_Fleet_scaled_baseline) 
...
Aug_30_18_Fleet_output_table <- emissions_fcn_event(Aug_30_18_Fleet_scaled_baseline) 
...
Demand_Graph33 <- ggplot(data = graph_table33, aes(x = Hr)) +
  ...
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="Fleet Hourly Demand Forecast",
  subtitle="July Baseline Scaled for July 31, 2018 Event (52 chargers) \n July 31, 2018 Event Usage (Load Reduction)",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=16,xmax=21,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
Jul_31_18_Fleet_output_table <- emissions_fcn_event(Jul_31_18_Fleet_scaled_baseline) 
...
Demand_Graph34 <- ggplot(data = graph_table34, aes(x = Hr)) +
  ...
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="Fleet Hourly Demand Forecast",
  subtitle="July Baseline Scaled for July 11, 2018 Event (32 chargers) \n July 11, 2018 Event Usage (Load Reduction)",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=16,xmax=21,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
Jul_11_18_Fleet_output_table <- emissions_fcn_event(Jul_11_18_Fleet_scaled_baseline) 
...
Demand_Graph35 <- ggplot(data = graph_table35, aes(x = Hr)) +
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="MUD Hourly Demand Forecast",
  subtitle="November Baseline Scaled for November 28, 2018 Event (10 chargers) \n November 28, 2018 Event Usage (Load Shift)",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=6,xmax=11,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
Nov_28_18_MUD_output_table <- emissions_fcn_event(Nov_28_18_MUD_scaled_baseline) 
...
Event: MUD, November 14, 2018, TOU EV-4, $0.05 Discount (11AM-3PM)
...
Demand_Graph36 <- ggplot(data = graph_table36, aes(x = Hr)) +
  ...
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="MUD Hourly Demand Forecast",
  subtitle="November Baseline Scaled for November 14, 2018 Event (10 chargers) \n November 14, 2018 Event Usage (Load Shift)",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=6,xmax=11,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
Nov_14_18_MUD_output_table <- emissions_fcn_event(Nov_14_18_MUD_scaled_baseline) 
...
Demand_Graph37 <- ggplot(data = graph_table37, aes(x = Hr)) +
  ...
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="MUD Hourly Demand Forecast",
  subtitle="October Baseline Scaled for October 30, 2018 Event (0 chargers) \n October 30, 2018 Event Usage (Load Shift)",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=6,xmax=11,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
Oct_30_18_MUD_output_table <- emissions_fcn_event(Oct_30_18_MUD_scaled_baseline) 
...
Demand_Graph38 <- ggplot(data = graph_table37, aes(x = Hr)) +
  geom_line(aes(y = value, color=condition)) +
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="MUD Hourly Demand Forecast",
  subtitle="October Baseline Scaled for October 16, 2018 Event (0 chargers) \n October 16, 2018 Event Usage (Load Shift)",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=6,xmax=11,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
Oct_16_18_MUD_output_table <- emissions_fcn_event(Oct_16_18_MUD_scaled_baseline) 
...
Demand_Graph39 <- ggplot(data = graph_table39, aes(x = Hr)) +
  ...
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="MUD Hourly Demand Forecast",
  subtitle="September Baseline Scaled for September 27, 2018 Event (22 chargers) \n September 27, 2018 Event Usage (Load Reduction)",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=16,xmax=21,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
Sep_27_18_MUD_output_table <- emissions_fcn_event(Sep_27_18_MUD_scaled_baseline) 
...
Demand_Graph40 <- ggplot(data = graph_table40, aes(x = Hr)) +
  ...
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="MUD Hourly Demand Forecast",
  subtitle="August Baseline Scaled for August 30, 2018 Event (10 chargers) \n August 30, 2018 Event Usage (Load Reduction)",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=16,xmax=21,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
Aug_30_18_MUD_output_table <- emissions_fcn_event(Aug_30_18_MUD_scaled_baseline) 
...
Demand_Graph41 <- ggplot(data = graph_table41, aes(x = Hr)) +
  ...
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="MUD Hourly Demand Forecast",
  subtitle="August Baseline Scaled for July 31, 2018 Event (22 chargers) \n July 31, 2018 Event Usage (Load Reduction)",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=16,xmax=21,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
Jul_31_18_MUD_output_table <- emissions_fcn_event(Jul_31_18_MUD_scaled_baseline) 
...
Demand_Graph42 <- ggplot(data = graph_table42, aes(x = Hr)) +
  ...
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="MUD Hourly Demand Forecast",
  subtitle="July Baseline Scaled for July 11, 2018 Event (23 chargers) \n July 11, 2018 Event Usage (Load Reduction)",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=16,xmax=21,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
Jul_11_18_MUD_output_table <- emissions_fcn_event(Jul_11_18_MUD_scaled_baseline) 
