...
Demand_GraphPDC1S <- ggplot(data = graph_tablePDC1S, aes(x = Hr)) +
  ...
  subtitle="Baseline July 2018 (234 Chargers) \n Model Simulation",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=6,xmax=11,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
Demand_GraphPDC5S <- ggplot(data = graph_tablePDC5S, aes(x = Hr)) +
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="Destination Centers (PDC5S) (Rebate, no comms, morning throttling) Hourly Demand Forecast",
  subtitle="Baseline November 2018 (234 Chargers) \n Model Simulation",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=6,xmax=11,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
  geom_rect(aes(xmin=11,xmax=15,ymin=-Inf,ymax=Inf, fill = "Rebate"),alpha=0.0075) +
  scale_x_continuous(breaks = 1:24, limits = c(1,24), expand = c(0, 0)) +
  scale_color_manual(labels=c("Baseline Demand","Intervention Demand"), values = c("purple", "blue")) +
  theme(plot.title = element_text(hjust = 0.5)) +
  theme(plot.subtitle = element_text(hjust = 0.5))+
...
#Demand_GraphPDC5S
ggsave("Results Graphs/Destination_Centers_PDC5S_Demand_Summary.pdf", Demand_GraphPDC5S, device = "pdf", width = 8, height = 4.5)
...
#Demand_GraphPF2
ggsave("Results Graphs/Fleets_PF2_Demand_Summary.pdf", Demand_GraphPF2, device = "pdf", width = 8, height = 4.5)
...
#Demand_GraphPF4S
ggsave("Results Graphs/Fleets_PF4S_Demand_Summary.pdf", Demand_GraphPF4S, device = "pdf", width = 8, height = 4.5)
...
#Demand_GraphPF5S
ggsave("Results Graphs/Fleets_PF5S_Demand_Summary.pdf", Demand_GraphPF5S, device = "pdf", width = 8, height = 4.5)
...
ggsave("Nov_14_WP_Event_Usage.pdf", Demand_Graph13, device = "pdf", width = 8, height = 4.5)
...
ggsave("Nov_28_WP_Event_Usage.pdf", Demand_Graph14, device = "pdf", width = 8, height = 4.5)
...
Oct_30_18_WP_scaled_model_run <- hourly_demand(
                    month = 10,
                    year = 2018,
                    seg =  "Workplace",
                    intervention_chargers =
...
Oct_30_18_WP_scaled_model_run$EV_Demand <- Oct_30_18_WP_scaled_model_run$EV_Demand %>%
  mutate(Event_Usage = Oct_30_18_WP_Event_Usage) 



graph_table15 <- Oct_30_18_WP_scaled_model_run$EV_Demand[c("Hr","X0","Event_Usage")] %>%
  gather(condition,value,c("X0","Event_Usage")) %>%
  mutate(Theoretical_Max=Oct_30_18_WP_scaled_model_run$EV_Demand$MT[1])
...
ggsave("Oct_30_WP_Event_Usage.pdf", Demand_Graph15, device = "pdf", width = 8, height = 4.5)

#COST
Cost_Table15 <- Oct_30_18_WP_scaled_model_run$EV_Demand[c("Hr","X0","P0","Event_Usage","P1")] %>% 
  mutate(Cost0 = X0*P0) %>% 
  mutate(Cost1 = Event_Usage*P1) %>% 
  mutate(Cost_diff = Cost1-Cost0)
#View(Cost_Table15)
...
Oct_16_18_WP_scaled_model_run <- hourly_demand(
                    month = 10,
                    year = 2018,
                    seg =  "Workplace",
                    intervention_chargers =
...
Oct_16_18_WP_scaled_model_run$EV_Demand <- Oct_16_18_WP_scaled_model_run$EV_Demand %>%
  mutate(Event_Usage = Oct_16_18_WP_Event_Usage)


graph_table16 <- Oct_16_18_WP_scaled_model_run$EV_Demand[c("Hr","X0","Event_Usage")] %>%
  gather(condition,value,c("X0","Event_Usage")) %>%
  mutate(Theoretical_Max=Oct_16_18_WP_scaled_model_run$EV_Demand$MT[1])
...
ggsave("Oct_16_WP_Event_Usage.pdf", Demand_Graph16, device = "pdf", width = 8, height = 4.5)


#COST
Cost_Table16 <- Oct_16_18_WP_scaled_model_run$EV_Demand[c("Hr","X0","P0","Event_Usage","P1")] %>% 
  mutate(Cost0 = X0*P0) %>% 
  mutate(Cost1 = Event_Usage*P1) %>% 
  mutate(Cost_diff = Cost1-Cost0)
#View(Cost_Table16)
...
ggsave("Sep_27_WP_Event_Usage.pdf", Demand_Graph17, device = "pdf", width = 8, height = 4.5)
...
ggsave("Aug_30_WP_Event_Usage.pdf", Demand_Graph18, device = "pdf", width = 8, height = 4.5)
...
ggsave("Jul_31_WP_Event_Usage.pdf", Demand_Graph19, device = "pdf", width = 8, height = 4.5)
...
Jul_11_18_scaled_model_run <- hourly_demand(
                    month = 7,
                    year = 2018,
                    seg =  "Workplace",
                    intervention_chargers =
...
Jul_11_18_scaled_model_run$EV_Demand <- Jul_11_18_scaled_model_run$EV_Demand %>%
  mutate(Event_Usage = Jul_11_18_Event_Usage)


graph_table43 <- Jul_11_18_scaled_model_run$EV_Demand[c("Hr","X0","Event_Usage")] %>%
  gather(condition,value,c("X0","Event_Usage")) %>%
  mutate(Theoretical_Max=Jul_11_18_scaled_model_run$EV_Demand$MT[1])
...
ggsave("Jul_11_WP_Event_Usage.pdf", Demand_Graph19, device = "pdf", width = 8, height = 4.5)

#Cost
Cost_Table43 <- Jul_11_18_scaled_model_run$EV_Demand[c("Hr","X0","P0","Event_Usage","P1")] %>% 
  mutate(Cost0 = X0*P0) %>% 
  mutate(Cost1 = Event_Usage*P1) %>% 
  mutate(Cost_diff = Cost1-Cost0)
#View(Cost_Table19)
...
ggsave("Nov_28_18_Fleet_Event_Usage.pdf", Demand_Graph28, device = "pdf", width = 8, height = 4.5)
...
ggsave("Nov_14_18_Fleet_Event_Usage.pdf", Demand_Graph28, device = "pdf", width = 8, height = 4.5)
...
ggsave("Oct_30_18_Fleet_Event_Usage.pdf", Demand_Graph29, device = "pdf", width = 8, height = 4.5)
```
...
ggsave("Oct_16_18_Fleet_Event_Usage.pdf", Demand_Graph28, device = "pdf", width = 8, height = 4.5)
...
ggsave("Sep_27_18_Fleet_Event_Usage.pdf", Demand_Graph28, device = "pdf", width = 8, height = 4.5)
...
ggsave("Aug_30_18_Fleet_Event_Usage.pdf", Demand_Graph32, device = "pdf", width = 8, height = 4.5)
...
ggsave("Jul_31_18_Fleet_Event_Usage.pdf", Demand_Graph33, device = "pdf", width = 8, height = 4.5)
...
ggsave("Jul_11_18_Fleet_Event_Usage.pdf", Demand_Graph34, device = "pdf", width = 8, height = 4.5)
...
ggsave("Nov_28_18_MUD_Event_Usage.pdf", Demand_Graph35, device = "pdf", width = 8, height = 4.5)
...
ggsave("Nov_14_18_MUD_Event_Usage.pdf", Demand_Graph36, device = "pdf", width = 8, height = 4.5)
...
ggsave("Oct_30_18_MUD_Event_Usage.pdf", Demand_Graph37, device = "pdf", width = 8, height = 4.5)
...
ggsave("Oct_16_18_MUD_Event_Usage.pdf", Demand_Graph38, device = "pdf", width = 8, height = 4.5)
...
ggsave("Sep_27_18_MUD_Event_Usage.pdf", Demand_Graph39, device = "pdf", width = 8, height = 4.5)
...
ggsave("Aug_30_18_MUD_Event_Usage.pdf", Demand_Graph40, device = "pdf", width = 8, height = 4.5)
...
ggsave("Jul_31_18_MUD_Event_Usage.pdf", Demand_Graph41, device = "pdf", width = 8, height = 4.5)
...
ggsave("Jul_11_18_MUD_Event_Usage.pdf", Demand_Graph42, device = "pdf", width = 8, height = 4.5)
