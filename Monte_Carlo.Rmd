...
Demand_Graph_WP_Public_Baseline <- ggplot(data = graph_tableFW1, aes(x = Hr)) +
  geom_line(aes(x = Hr,
      ...
      ylab("Electricity Demand (kW)") +
  scale_x_continuous(limits = c(0,24),breaks = c(0:24), expand = c(0,0)) +
    scale_y_continuous(expand = c(0,0), labels = scales::unit_format(unit = "k", scale =1e-3))+ #NEW
...
Demand_Graph_WP_Public <- ggplot(data = graph_tableFW1, aes(x = Hr)) +
  ...
  geom_rect(aes(xmin= 6,
                ...
                alpha=0.005) +
  scale_x_continuous(limits = c(0,24),breaks = c(0:24), expand = c(0,0)) +
  scale_y_continuous(expand = c(0,0), labels = scales::unit_format(unit = "k", scale =1e-3))+
...
Demand_Graph_DC_Public_Baseline <- ggplot(data = graph_tableFDC1, aes(x = Hr)) +
      ...
      ylab("Electricity Demand (kW)") +
  scale_x_continuous(limits = c(0,24),breaks = c(0:24), expand = c(0,0)) +
    scale_y_continuous(expand = c(0,0), breaks = c(1000, 2000), labels = scales::unit_format(unit = "k", accuracy = 0.5, scale =1e-3))+ #NEW
      theme(legend.position = "none") + #NEW
      scale_color_manual('Demand', values = c("Baseline Demand" = "#DE7808", "Intervention Demand" ="#2B4A6D"))
...
Demand_Graph_DC_Public <- ggplot(data = graph_tableFDC1, aes(x = Hr)) +
  ...
  geom_rect(aes(xmin= 16,
                ...
                alpha=0.005) +
  scale_x_continuous(limits = c(0,24),breaks = c(0:24), expand = c(0,0)) +
   scale_y_continuous(expand = c(0,0), labels = scales::unit_format(unit = "k", accuracy = 0.5, scale =1e-3)) +
      scale_fill_manual('Interventions', values = c("Discount" = "#88A550","Throttle" = 'gray57', "Rebate" = "#88A550"),  guide = guide_legend(override.aes = list(alpha = 0.1))) +
      theme(legend.position = "none") +
      scale_color_manual('Demand', values = c("Baseline Demand" = "#DE7808", "Intervention Demand" ="#2B4A6D"))
