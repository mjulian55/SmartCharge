...
#calculate marginal emissions for change in demand
Emissions <- Emissions %>%
  mutate (CO2Xdelta = Xdelta*CO2Marginal) %>% 
  mutate (NOXXdelta= Xdelta*NOXMarginal)

#calculate change in emissions from X0 to Xf
Emissions <- Emissions %>%
  mutate (CO2change = CO2X0-CO2Xdelta) %>% # baseline emissions - final emissions for delta 
  mutate (NOXchange = NOXX0-NOXXdelta)
