...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
FLEET
#Scenario 27 - July 11, 2018 Fleet EVENT + Baseline (scaled for 146 chargers) 

Event: Fleet, July 11, 2018, TOU EV-4, $0.10 Rebate (4-9PM)
...
graph_table27 <- Nov_28_18_Fleet_scaled_baseline$EV_Demand[c("Hr","X0","Event_Usage")] %>%
  gather(condition,value,c("X0","Event_Usage")) %>%
  mutate(Theoretical_Max=Nov_28_18_Fleet_scaled_baseline$EV_Demand$MT[1])


Demand_Graph27 <- ggplot(data = graph_table28, aes(x = Hr)) +
  geom_line(aes(y = value, color=condition)) +
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="Destination Center Hourly Demand Forecast",
...
#COST
Cost_Table27 <- Nov_28_18_Fleet_scaled_baseline$EV_Demand[c("Hr","X0","P0","Event_Usage","P1")] %>% 
  mutate(Cost0 = X0*P0) %>% 
  mutate(Cost1 = Event_Usage*P1) %>% 
  mutate(Cost_diff = Cost1-Cost0)
#View(Cost_Table24)
...
#Scenario 28 - Nov 14, 2018 Fleet EVENT + Baseline (scaled for 146 chargers) 
...
Nov_14_18_Fleet_scaled_baseline$EV_Demand <- Nov_28_18_Fleet_scaled_baseline$EV_Demand %>%
  mutate(Event_Usage = Nov_28_18_Fleet_Event_Usage)
...
Demand_Graph28 <- ggplot(data = graph_table28, aes(x = Hr)) +
  ...
  subtitle="November 2018 Baseline Scaled for Nov 14, 2018 Event \n November 14, 2018 Event Usage (Load Shift)",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=16,xmax=21,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
#Scenario 29 - Oct 30, 2018 Fleet EVENT + Baseline (scaled for 146 chargers) 
...
Demand_Graph29 <- ggplot(data = graph_table29, aes(x = Hr)) +
  ...
  subtitle="October 2018 Baseline Scaled for Oct 30, 2018 Event \n October 30, 2018 Event Usage (Load Shift)",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=16,xmax=21,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
#Scenario 30 - October 16, 2018 Fleet EVENT + Baseline (scaled for X chargers) 
...
Potential_Graph30 <- Demand_Graph27 +
geom_line(aes(y=Theoretical_Max))
...
#Scenario 31 - September 27, 2018 Fleet EVENT + Baseline (scaled for X chargers) 
...
Demand_Graph31 <- ggplot(data = graph_table31, aes(x = Hr)) +
  ...
  subtitle="September 2018 Baseline Scaled for September 27, 2018 Event \n September 27, 2018 Event Usage (Load Reduction)",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=16,xmax=21,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
Demand_Graph32 <- ggplot(data = graph_table32, aes(x = Hr)) +
  ...
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="Fleet Hourly Demand Forecast",
  subtitle="August 2018 Baseline Scaled for August 30, 2018 Event \n August 30, 2018 Event Usage (Load Reduction)",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=16,xmax=21,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
#Scenario 33 - July 31, 2018 Fleet EVENT + Baseline (scaled for X chargers) 
...
Demand_Graph33 <- ggplot(data = graph_table33, aes(x = Hr)) +
  ...
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="Fleet Hourly Demand Forecast",
  subtitle="July Baseline Scaled for July 31, 2018 Event \n July 31, 2018 Event Usage (Load Reduction)",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=16,xmax=21,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
#Scenario 34 - July 11, 2018 Fleet EVENT + Baseline (scaled for X chargers) 
...
Demand_Graph34 <- ggplot(data = graph_table34, aes(x = Hr)) +
  ...
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="Fleet Hourly Demand Forecast",
  subtitle="July Baseline Scaled for July 11, 2018 Event \n July 11, 2018 Event Usage (Load Reduction)",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=16,xmax=21,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
#Scenario 35 - November 28, 2018 MUD EVENT + Baseline (scaled for X chargers) 

Event: Fleet, November 28, 2018, TOU EV-4, $0.05 Discount (11AM-3PM)
...
Demand_Graph35 <- ggplot(data = graph_table35, aes(x = Hr)) +
  ...
  subtitle="November Baseline Scaled for November 28, 2018 Event \n November 28, 2018 Event Usage (Load Shift)",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=6,xmax=11,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
#Scenario 36 - November 14, 2018 MUD EVENT + Baseline (scaled for X chargers) 
...
Demand_Graph36 <- ggplot(data = graph_table36, aes(x = Hr)) +
  ...
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="MUD Hourly Demand Forecast",
  subtitle="November Baseline Scaled for November 14, 2018 Event \n November 14, 2018 Event Usage (Load Shift)",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
  geom_rect(aes(xmin=6,xmax=11,ymin=-Inf,ymax=Inf,fill="Throttle"),alpha=0.0075) +
...
#Scenario 41 - July 31, 2018 MUD EVENT + Baseline (scaled for 10 chargers) 
