...
write_csv(FW1$sim_result_summary, "Results/Workplace_PW6S_Demand_Summary.csv")

FW1_output_table <- emissions_fcn(FW1) 
write_csv(FW1_output_table$Emissions_Table, "Results/Workplace_PW6S_Output_Summary.csv") #write emissions to csv
...
#PW2S Graph (discount + price comm + morning throttling)
...
Demand_GraphPW2S <- ggplot(data = graph_tablePW2S, aes(x = Hr)) +
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
  panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  labs(title="Workplaces (PW2S) (discount, price comm, throttling) Hourly Demand Forecast",
  subtitle="Baseline July 2018 (596 Chargers) \n Model Simulation",
  y="EV Charging Demand (kW)",
  x="Hour",
  color=NULL) +
...
#Method1 -- default run above
Method1_test_for_graph <- Method1_test$EV_Demand

#Method 1 -- broken scenario
Method1_broken <- hourly_demand(method = 1, include_wknds = FALSE, price_comm = FALSE, elasticity_schedule = 7, price_change = -0.05, intervention_hours = c(5)) 

Method1_broken_for_graph <- Method1_broken$EV_Demand
