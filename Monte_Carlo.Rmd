...
#sum hours of demand change in target window and multiply by % assume are solar. 
CurtailmentReduction <- 0.75*Xdelta_i_h
Curtailmentcost_i_h <- CurtailmentReduction*-Curtailmentcost

#add to output table
Emissions_Table <- Emissions_Table %>% 
  mutate(CurtRed = c(CurtailmentReduction, "NA", "NA", CurtailmentReduction)) %>% 
...
Emissions_run1 <- emissions_fcn(EVDemand = hourly_demand())
