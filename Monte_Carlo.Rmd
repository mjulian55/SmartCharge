...
Nov_14_18_baseline_usage_scaled <- hourly_demand(price_change = 0, 
                                                 throttle_amount = 0, 
                                                 month = "Nov_18", 
                                                 segment = "Workplace", 
...
#COST
Cost_Table13 <- Nov_14_18_scaled_model_run$EV_Demand[c("Hr","X0","P0","Event_Usage","P1")] %>% 
  mutate(Cost0 = X0*P0) %>% 
...
#CHARGERS
#filter Event Chargers DF to return the # of chargers in use at all workplaces on November 28, 2018
...
#scale the baseline number of chargers to the same number of chargers during the Nov 28 event
Nov_28_18_scaled_model_run <- hourly_demand(price_change = -0.05,
                    throttle_amount = -0.5,
                    month = 11,
                    year=2018,
                    segment =  "Workplace",
...
#specify the event kwh usage on November 28, 2018
nov_28_18_Event_Usage <- Workplace_Event_Total_Usage$`11/28/2018`[3:26]

#add new event usage column to the Nov 28 scaled model run (baseline, not interventions) in order to graph later
Nov_28_18_scaled_model_run$EV_Demand <- Nov_28_18_scaled_model_run$EV_Demand %>%
  mutate(Event_Usage = nov_28_18_Event_Usage)

#organize original demand (baseline, X0), and Event usage data into an hourly table; add a theoretical max column based on the number of chargers in the event date
graph_table14 <- Nov_28_18_scaled_model_run$EV_Demand[c("Hr","X0","Event_Usage")] %>%
  gather(condition,value,c("X0","Event_Usage")) %>%
  mutate(Theoretical_Max=Nov_28_18_scaled_model_run$EV_Demand$MT[1])

#graph scaled baseline data and event data onto a single graph
...
#separate graph with the theoretical max as a line
...
#COST
#create a table with the difference in cost between the intial demand (x0) and initial price (p0), vs event demand (Event_usage) and event price (P1)
Cost_Table14 <- Nov_28_18_scaled_model_run$EV_Demand[c("Hr","X0","P0","Event_Usage","P1")] %>% 
  mutate(Cost0 = X0*P0) %>% 
  mutate(Cost1 = Event_Usage*P1) %>% 
  mutate(Cost_diff = Cost1-Cost0) 
#View(Cost_Table14)
...
Oct_30_18_scaled_model_run <- hourly_demand(price_change = -0.05,
                    throttle_amount = -0.5,
                    month = 10,
                    year = 2018,
                    segment =  "Workplace",
...
Oct_30_18_Event_Usage <- Workplace_Event_Total_Usage$Oct_30_18_LS
...
Oct_16_18_scaled_model_run <- hourly_demand(price_change = -0.05,
                    throttle_amount = -0.5,
                    month = 10,
                    year = 2018,
                    segment =  "Workplace",
...
Oct_16_18_Event_Usage <- Workplace_Event_Total_Usage$Oct_16_18_LS
...
Sep_27_18_scaled_model_run <- hourly_demand(price_change = -.10,
                    throttle_amount = -.5,
                    month = 9,
                    year = 2018,
                    segment =  "Workplace",
...
Sep_27_18_Event_Usage <- Workplace_Event_Total_Usage$Sep_27_18_LR

Sep_27_18_scaled_model_run$EV_Demand <- Sep_27_18_scaled_model_run$EV_Demand %>%
  mutate(Event_Usage = Sep_27_18_Event_Usage)


graph_table17 <- Sep_27_18_scaled_model_run$EV_Demand[c("Hr","X0","Event_Usage")] %>%
  gather(condition,value,c("X0","Event_Usage")) %>%
  mutate(Theoretical_Max=Sep_27_18_scaled_model_run$EV_Demand$MT[1])
...
#Cost
Cost_Table17 <- Sep_27_18_scaled_model_run$EV_Demand[c("Hr","X0","P0","Event_Usage","P1")] %>% 
  mutate(Cost0 = X0*P0) %>% 
  mutate(Cost1 = Event_Usage*P1) %>% 
  mutate(Cost_diff = Cost1-Cost0)
#View(Cost_Table17)
...
Aug_30_18_scaled_model_run <- hourly_demand(price_change = -.10,
                    throttle_amount = -.5,
                    month = "Sep_18",
                    segment =  "Workplace",
                    intervention_chargers =
...
Aug_30_18_Event_Usage <- Workplace_Event_Total_Usage$Aug_30_18_LR
...
Jul_31_18_scaled_model_run <- hourly_demand(price_change = -.10,
                    throttle_amount = -.5,
                    month = "Sep_18",
                    segment =  "Workplace",
                    intervention_chargers =
...
Jul_31_18_Event_Usage <- Workplace_Event_Total_Usage$Jul_31_18_LR
...
Nov_28_18_DC_scaled_model_run <- hourly_demand(price_change = -.05,
                    throttle_amount = -.5,
                    month = "Nov_18",
                    segment =  "Destination Center",
                    intervention_chargers =
...
nov_28_18_DC_Event_Usage <- DC_Event_Total_Usage$Nov_28_18_LS
...
graph_table18 <- Nov_28_18_DC_scaled_model_run$EV_Demand[c("Hr","X0","Event_Usage")] %>%
  gather(condition,value,c("X0","Event_Usage")) %>%
...
ggsave("Nov_28_DC_Event_Usage.pdf", Demand_Graph18, device = "pdf", width = 8, height = 4.5)
