...
EV_Demand <- mutate(price_schedule, Xi = select(baseline, month), X0 = select(baseline, month)/baseline_chargers*intervention_chargers) #340 here comes from the number of chargers installed for the baseline
