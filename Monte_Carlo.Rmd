...
WP_D_R_T <- hourly_demand(seg = "Workplace", 
                        month = "June_18", 
...
#MODEL RUN
WP_C_D_T_TOU_SUmmer_4 <- hourly_demand(seg = "Workplace", 
                                       month = "Nov_18",
                                       price_change = -0.05,
...
##MODEL RUN
MUD_R_C <- hourly_demand(seg = "Multi Unit Dwelling", 
                         month = "June_18", 
                         price_change = 0.1 , 
...
#MODEL RUN
DC_D_T_NC <- hourly_demand(seg = "Destination Center", 
                           month = "June_18", 
                           intervention_hours = c(12:15),
                           price_change = -0.05, 
...
#MODEL RUN
Fleet_R <-  hourly_demand(seg = "Fleet", 
                        month = "Aug_18", 
                        intervention_hours = c(17:21), 
                        price_change = 0.1)
...
#MODEL RUN
WP_D_T <- hourly_demand(seg = "Workplace", 
                        month = "Nov_18", 
                        intervention_hours = c(12:15),
                        price_change = -0.05,
                        throttle_amount = -0.5,
...
EV_Demand_run1 <- hourly_demand(seg = "Workplace", month = "June_18",intervention_comm_effect = 1, throttle_amount = 0,throttle_hours = c(6:11), price_change = -0.05, intervention_hours = c(12:15))
