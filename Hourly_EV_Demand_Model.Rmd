...
#Calculate P-SOP Ratio of inputted price schedule
P_SOP_Ratio <- max(price_schedule$P0)/min(price_schedule$P0)


#Find the SDGE Rate Schedule with the closest ratio and use those elasticities
closest_schedule <- SDGE_P_SOP_Ratios$Rate_Schedule[which.min(abs(SDGE_P_SOP_Ratios$P_SOP_Ratio - P_SOP_Ratio))]
Chosen_Ratio <- SDGE_P_SOP_Ratios$P_SOP_Ratio[which.min(abs(SDGE_P_SOP_Ratios$P_SOP_Ratio - P_SOP_Ratio))]
