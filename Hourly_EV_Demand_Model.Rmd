...
Demand_Graph <- ggplot(data = EV_Demand, aes(x = Hr)) +
  geom_line(aes(y = Xt), color = "blue") +
  geom_line(aes(y = X0), color = "green") +
  ...
  labs(title="Hourly Demand Forecast", 
       ...
       x="Hour",
       color=NULL) +
  scale_x_continuous(breaks = 1:24, limits = c(0,24), expand = c(0, 0)) +
  geom_rect(aes(xmin=11,xmax=15,ymin=-Inf,ymax=Inf),alpha=0.0075,fill="green") +
  geom_rect(aes(xmin=6,xmax=11,ymin=-Inf,ymax=Inf),alpha=0.0075,fill="yellow") +
